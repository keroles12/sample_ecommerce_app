        ...
        <div class="col-md-4">
                     <div class="card mb-4 product-wap rounded-0">
                         <div class="card rounded-0">
                             <img class="" height="200" src="${product[index].image}">
                             <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                 <ul class="list-unstyled">
                                     <li><a class="btn btn-success text-white mt-2 add-card"><i class="fas fa-cart-plus"></i></a></li>
                                 </ul>
                             </div>
                         </div>
                         <div class="card-body">
                             <a href="shop-single.html" class="fw-bold fs-5 text-decoration-none">${product[index].name}</a>
                             <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                 <li></li>
                                 
                             </ul>
                             
                             <p class=" fs-6 fw-bold mt-2">$${product[index].price}</p>
                         </div>
                     </div>
                 </div>
        `
